        ...
        <div class="w-full max-w-md">
          <div class="border border-white/10 rounded-xl p-8 sm:p-10 backdrop-blur-sm
            ...
            <div class="w-32 h-32 flex items-center justify-center mb-6">
              <img src="logo.png" alt="Divergente" class="w-full h-full object-contain drop-shadow-[0_0_24px_rgba(67,97,238,0.5)]" />
            </div>
            ...
            <!-- Error message -->
            @if (errorMsg) {
              <div class="w-full mt-4 p-sm bg-error-container/20 border border-error/50
